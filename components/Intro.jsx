...
export default function Intro() {
  ...
  return (
    <>
      ...
      <div className='w-full flex items-center lg:justify-start py-24 justify-center flex-wrap  '>
      ...
      {
        doneSearch && (
          <div className='bg-white w-full flex flex-wrap items-center justify-center py-2 px-2'>
            {
